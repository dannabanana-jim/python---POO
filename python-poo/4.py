...
#Además, esta clase , debe tener un método para mostrar nombre_completo() el cual debe mostrar
...
estudiante1 = Estudiante("Juan", "Pérez", "Ingeniería de Software")
print(f"Nombre completo: {estudiante1.nombre_completo()}")
